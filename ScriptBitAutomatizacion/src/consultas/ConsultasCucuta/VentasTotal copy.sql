...
WHERE
T1."DocDate" BETWEEN 20240501 AND 20240517 --ADD_DAYS(LAST_DAY(ADD_MONTHS(CURRENT_DATE, -20240501 AND 20240517 )),+1) AND  ADD_DAYS(TO_VARCHAR(CURRENT_DATE,'YYYYMMDD'), -1 )
